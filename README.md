...
This repository contains small beginner-friendly JavaScript projects that I built to practice basic concepts like DOM manipulation, functions, event handling, and simple UI logic.
Each project is inside its own folder and can be opened directly in the browser.
...
- Download or clone the repository:
  ...
  - git clone https://github.com/Sekhard26/JS-projects.git
